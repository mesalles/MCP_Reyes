# %% UJI API Client
## Client for interacting with UJI Academic Information System APIs
...
class SimpleCache:
    ...
    def set(self, key: str, value: Any, expiry_minutes: int = UJIConfig.CACHE_EXPIRY_MINUTES):
...
class UJIAcademicClient:
    ...
    def __init__(self, timeout: int = UJIConfig.DEFAULT_TIMEOUT):
    ...
    # %% Subject Methods
    ## Methods for subject-related API endpoints
...
def create_uji_client(timeout: int = UJIConfig.DEFAULT_TIMEOUT) -> UJIAcademicClient:
